...
export function processBTCUSD(closingPrice, newTimeStamp) {
  ...
  if (newTimeStamp - prevTimeStamp >= FIFTEEN_MINUTES_MICROSECONDS) {
      ...
      if( prevConditionBuyUp &&
        ...
        console.log(`Buy BTCUSD Up EMA30: ${currEma30Value}, EMA50: ${currEma50Value}, EMA100: ${currEma100Value}, timestamp: ${newTimeStamp}`);
        alert(`Buy BTCUSD Up => EMA30: ${currEma30Value}, EMA50: ${currEma50Value}, EMA100: ${currEma100Value}, timestamp: ${newTimeStamp}`);
      }

      let prevConditionSellUp = !(prevEma9Value < prevEma50Value);
      if(prevConditionSellUp &&
         currEma9Value < currEma50Value) {
        console.log(`Sell BTCUSD Up EMA9: ${currEma9Value}, EMA50: ${currEma50Value}, timestamp: ${newTimeStamp}`);
        alert(`Sell BTCUSD Up => EMA9: ${currEma9Value}, EMA50: ${currEma50Value}, timestamp: ${newTimeStamp}`);
      }
      ...
      if( prevConditionBuyDown &&
         currEma30Value < currEma50Value &&
         currEma50Value < currEma100Value) {
        console.log(`Buy BTCUSD Down EMA30: ${currEma30Value}, EMA50: ${currEma50Value}, EMA100: ${currEma100Value}, timestamp: ${newTimeStamp}`);
        alert(`Buy BTCUSD Down => EMA30: ${currEma30Value}, EMA50: ${currEma50Value}, EMA100: ${currEma100Value}, timestamp: ${newTimeStamp}`);
      }

      let prevConditionSellDown = !(prevEma9Value > prevEma50Value);
      if(prevConditionSellDown &&
         currEma9Value > currEma50Value) {
        console.log(`Sell BTCUSD Down EMA9: ${currEma9Value}, EMA50: ${currEma50Value}, timestamp: ${newTimeStamp}`);
        alert(`Sell BTCUSD Down => EMA9: ${currEma9Value}, EMA50: ${currEma50Value}, timestamp: ${newTimeStamp}`);
      }
